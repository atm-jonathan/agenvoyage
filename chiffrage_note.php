...
/**
 *  \file       chiffrage_note.php
 *  \ingroup    chiffrage
 *  \brief      Tab for notes on Chiffrage
 */
...
$langs->loadLangs(array("chiffrage@chiffrage", "companies"));
...
$hookmanager->initHooks(array('chiffragenote', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->chiffrage->multidir_output[$object->entity]."/".$object->id;
}

$permissionnote = $user->rights->chiffrage->chiffrage->write; // Used by the include of actions_setnotes.inc.php
$permissiontoadd = $user->rights->chiffrage->chiffrage->write; // Used by the include of actions_addupdatedelete.inc.php
...
$help_url = '';
llxHeader('', $langs->trans('Chiffrage'), $help_url);
