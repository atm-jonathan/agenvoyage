...
class Chiffrage extends CommonObject
{
	...
	public $fields=array(
		...
		'dev_estimate' => array('type'=>'integer:User:user/class/user.class.php:1:statut=1', 'label'=>'CHIDevEstimate', 'enabled'=>'1', 'position'=>51, 'notnull'=>0, 'visible'=>5,),
		'po_estimate' => array('type'=>'integer:User:user/class/user.class.php:1:statut=1', 'label'=>'CHIPOEstimate', 'enabled'=>'1', 'position'=>52, 'notnull'=>1, 'visible'=>1,),
